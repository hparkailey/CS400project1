...
public class TestMovieAndMovieDataReader {
  ...
  public boolean testMovieYear() {
    ...
    correctYear = ((year.equals(movieList.get(0).getYear()))
        && (year.equals(movieList.get(1).getYear())) && (year.equals(movieList.get(2).getYear())));
    return correctYear;
  }
  ...
  public boolean testReaderMovieDescriptions() {
    ...
    boolean correctDescriptions = true;
    // System.out.println("test1 " + description3.equals(movieList.get(2).getDescription()));
    // System.out.println("description3: " + description3);
    // System.out.println("movieList2: " + movieList.get(2).getDescription()); //TODO
    correctDescriptions = (description1.equals(movieList.get(0).getDescription())
        && description2.equals(movieList.get(1).getDescription())
        && description3.equals(movieList.get(2).getDescription()));
    return correctDescriptions;
  }
